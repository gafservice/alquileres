...
if uso in ["Uso comercial", "Uso mixto"]:
    ...
    form_data["Permisos Ministerio de Salud"] = st.radio("¿Cuenta con permisos del Ministerio de Salud?", ["Sí", "No"])
...
form_data["Pago servicios"] = st.radio("¿Quién se encargará del pago de los servicios públicos?", ["El inquilino", "El propietario", "A convenir entre ambas partes"])
...
Nuestro equipo revisará su información y le de nuestra decisión por este mismo medio.
...
"""
            ...
            with smtplib.SMTP("smtp.gmail.com", 587) as server:
                server.starttls()
                server.login("admin@vigias.net", st.secrets["EMAIL_PASSWORD"])
